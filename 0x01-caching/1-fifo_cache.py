#!/usr/bin/python3
"""FIFOCache module This module defines a FIFOCache class that inherits from
BaseCaching.

It implements a caching system using the FIFO algorithm.
"""
...
class FIFOCache(BaseCaching):
    """FIFOCache class This class inherits from BaseCaching and implements a
    ...
    def put(self, key, item):
        ...
        than BaseCaching.MAX_ITEMS, it discards the first item put in
        cache (FIFO algorithm) and prints a discard message.
        """
